...
if ( $has_access ) : ?>
	<div class="pmpro pmpro_download_button">
		<a class="pmpro_btn pmpro_download_btn_cta" href="<?php echo esc_url( $download_url ); ?>">
			...
			<span class="pmpro_download_btn_text">
				...
				<small><?php echo esc_html( $display_name ); ?></small>
			</span>
		</a>
	</div>
...
<?php else : ?>
	<div class="pmpro pmpro_download_button pmpro_download-locked">
		<a class="pmpro_btn pmpro_btn-cancel pmpro_download_btn_cta" href="<?php echo esc_url( $no_access_url ); ?>">
			<span class="pmpro_download_btn_icon">
